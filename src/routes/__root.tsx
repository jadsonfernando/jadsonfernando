...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Educação Profissional e Tecnológica
...
Google Gemini Academy" },
      ...
      { property: "og:description", content: "Educação Profissional e Tecnológica
...
Google Gemini Academy" },
      ...
      { name: "twitter:description", content: "Educação Profissional e Tecnológica
