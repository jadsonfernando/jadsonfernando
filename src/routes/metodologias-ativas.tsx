  ...
  return (
    <SiteLayout>
      ...
      >
        ...
        <div className="mt-24 grid md:grid-cols-12 gap-10 items-center border-t border-border pt-16">
          <div className="md:col-span-5">
            <div className="text-[11px] uppercase tracking-[0.25em] text-muted-foreground">Princípio</div>
